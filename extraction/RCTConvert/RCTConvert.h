...
// TODO(platform-extraction): Remove this UIKit import once NSLineBreakMode,
// NSTextAlignment, NSUnderlineStyle, NSWritingDirection, and NSLineBreakStrategy
// are either moved to the UIKit category or handled via platform-conditional imports.
// These types live in UIKit on iOS and AppKit on macOS.
...
// Compat re-export: consumers importing <React/RCTConvert.h> still get all
// UIKit-specific methods. This makes the split invisible to existing code.
#import <React/RCTConvert+UIKit.h>
