...
// ============================================================================
// UIKit-specific enum converters
// ============================================================================
...
+ (UIEdgeInsets)UIEdgeInsets:(id)json
{
  ...
  if ([json isKindOfClass:[NSNumber class]]) {
    ...
    UIEdgeInsets result;
    // convertCGStruct is static in RCTConvert.mm, so we inline the logic here
    ...
    if ([json isKindOfClass:[NSArray class]]) {
      if (RCT_DEBUG && [json count] != count) {
        ...
        CGFloat *resultPtr = (CGFloat *)&result;
        for (NSUInteger i = 0; i < count; i++) {
          resultPtr[i] = [RCTConvert CGFloat:RCTNilIfNull(json[i])];
        }
      }
    } else if ([json isKindOfClass:[NSDictionary class]]) {
      CGFloat *resultPtr = (CGFloat *)&result;
      for (NSUInteger i = 0; i < count; i++) {
        resultPtr[i] = [RCTConvert CGFloat:RCTNilIfNull(json[fields[i]])];
      }
    } else if (json) {
      RCTLogConvertError(json, @"UIEdgeInsets");
    }
    return result;
  }
}
...
// ============================================================================
// Deprecated UIKit methods (UIImage, CGImage)
// ============================================================================
...
@implementation RCTConvert (UIKit_Deprecated)
